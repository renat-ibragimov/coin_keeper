...
def password_reset_email(to: str, reset_url: str, ttl_hours: int) -> EmailMessage:
    ...
    return EmailMessage(to=to, subject="Reset your Bakost Numismatics password", body=body)
