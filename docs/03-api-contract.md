...
`collection_item_id` у старых расходов (см. бэкфилл, `04-business-rules.md`, п. 4). В
...
покупку целиком, а не за экземпляр (`04-business-rules.md`, п. 4). Подробности удаления —
там же, п. 10.
