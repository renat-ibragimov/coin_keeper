...
Записи общего каталога (`created_by IS NULL`) создаёт, правит и удаляет **только
...
- Общую позицию каталога может удалить только администратор, личную — её автор.
  Пользователь не может удалить общую запись даже при отсутствии экземпляров.
