...
(`countries.catalog_confirmed`, `04-business-rules.md`, п. 13a), и только в самом списке
...
каталога, видна в «Серії» и в Огляді/дашборді тоже: те экраны про личную коллекцию
...
- «Опис» — текст парсера coin-collector (`CatalogCard.description`, докс
  `02-data-model.md`) на текущей локали интерфейса с запасным вариантом на другую,
