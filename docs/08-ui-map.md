...
Тёмная тема (уголь и тёплый графит, приглушённое старое золото — наследница legacy
`#08090b`) — **вторая, равноправная**, и получает ту же лестницу и ту же систему высот.
