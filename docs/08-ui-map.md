...
- **Порожній стан**: «Фінансової історії поки немає. Коли ви додасте покупку, тут
  з'являться витрати, поточна оцінка та різниця.» + «Додати першу монету» (в каталог).
  Стан «покупок немає, супутні витрати додайте вручну» лишається для непорожньої
  колекції без жодної витрати.
