...
- Ліва колонка («Найближчі…» + «Розподіл за країнами») і права («Фінанси» +
  «Курси НБУ») вирівняні по висоті сіткою (`align-items: stretch`); перша
  картка кожної колонки розтягується, щоб низ обох колонок збігався і
  «Розподіл за країнами» не виглядав вибитим.
