...
- «Экспортировать текущий фильтр в Excel» — после MVP, решение владельца 2026-09-15
  (`01-scope-mvp.md`); текст ниже — восстановленный legacy-экран, при реализации сверить
...
пробел в каталоге», а заводит свою запись (`01-scope-mvp.md`). **В MVP кнопка одна** —
...
(`03-api-contract.md`, `06-media-storage.md`).
