...
Первый и пока единственный раздел. Таблица прогонов, свежие сверху: состояние, задача,
...
«Схоже, зупинилася — прогін так і не завершився». Сторожа у нас пока нет (`13-admin.md`,
