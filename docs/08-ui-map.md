...
- Заголовок «Огляд колекції» и подзаголовок центрированы через `PageHeader
  align="center"` (той самий компонент центрує шапку «Мої монети» на екрані
  Монети); подзаголовок — фиксированный текст «Усі важливі цифри та прогрес
  моєї колекції в одному місці.», без e-mail пользователя.
