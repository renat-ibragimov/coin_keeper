...
Личные позиции появляются двумя путями: вручную и **импортом**.

**Вручную — прямо на странице «Додати»**, когда вы записываете покупку. Выбираете страну,
начинаете набирать название; если монета нашлась в каталоге — записываем покупку к ней,
если нет — тут же под названием появляются поля «Про монету», и монета вместе с покупкой
сохраняются одним действием. Отдельной страницы «создать позицию каталога» нет: вы
записываете купленную монету, а не заводите каталожную запись. Обязательного немного —
страна, название, год, тип и материал; остальное можно дополнить позже.

**Импортом.** Загрузка выгрузки с uCoin или импорт монеты по ссылке создают именно личные
позиции — и только те, которых не нашлось в общем каталоге. Если монета в общем каталоге
уже есть, ваш экземпляр просто привяжется к ней, и дубликата не возникнет.
