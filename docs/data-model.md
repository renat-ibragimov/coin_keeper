...
импортом не пополняется — правило дедупликации в `business-rules.md`, п. 3.
...
Правила обновления — `business-rules.md`, п. 7, и `integrations.md`.
...
позиция может быть монетой какого угодно эмитента (`business-rules.md`, п. 2).
...
(`business-rules.md`, п. 2). Вписанное имя выводится рядом с монетой (общий
...
пользователя — это и есть правило дедупликации импорта из `business-rules.md`, п. 3.
...
архивированной общей записи администратором (`business-rules.md`, п. 10).
...
трат. См. `business-rules.md`, п. 10.
...
`catalog_item_id`. Подробности и обоснование — `business-rules.md`, п. 4.
