...
// A group without a backend-supplied label (the "без значення" bucket) still
// needs a stable sort key: its raw value reads better than an empty string
// tying every such row together.
